...
/**
 * This class defines the structure of the 'poste' table.
 *
 *
 *
 ...
 */
class PosteTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = '.map.PosteTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('poste');
        $this->setPhpName('Poste');
        $this->setClassname('Happster\\Model\\Poste');
        $this->setPackage('');
