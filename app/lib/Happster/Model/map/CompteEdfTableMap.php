...
/**
 * This class defines the structure of the 'compte_edf' table.
 *
 *
 *
 ...
 */
class CompteEdfTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = '.map.CompteEdfTableMap';
    ...
    {
        // attributes
        $this->setName('compte_edf');
        $this->setPhpName('CompteEdf');
        $this->setClassname('Happster\\Model\\CompteEdf');
        $this->setPackage('');
        ...
        $this->addColumn('adresse', 'Adresse', 'VARCHAR', true, 255, null);
        $this->addColumn('ville', 'Ville', 'VARCHAR', true, 255, null);
        $this->addColumn('code_postal', 'CodePostal', 'INTEGER', true, 5, null);
        $this->addColumn('budget_souhaite', 'BudgetSouhaite', 'INTEGER', true, 5, null);
        $this->addColumn('prix_abonnement', 'PrixAbonnement', 'INTEGER', true, 5, null);
