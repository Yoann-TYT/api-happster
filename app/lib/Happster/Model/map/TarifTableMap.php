...
/**
 * This class defines the structure of the 'tarif' table.
 *
 *
 *
 ...
 */
class TarifTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = '.map.TarifTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('tarif');
        $this->setPhpName('Tarif');
        $this->setClassname('Happster\\Model\\Tarif');
        $this->setPackage('');
