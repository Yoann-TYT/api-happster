...
abstract class BaseActivite extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Happster\\Model\\ActivitePeer';
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ActivitePeer::TIME;
            }
    ...
    public function setProduction($v)
    {
        ...
        if ($this->production !== $v) {
            $this->production = $v;
            $this->modifiedColumns[] = ActivitePeer::PRODUCTION;
        }
    ...
    public function setConsommation($v)
    {
        ...
        if ($this->consommation !== $v) {
            $this->consommation = $v;
            $this->modifiedColumns[] = ActivitePeer::CONSOMMATION;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ActivitePeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ActivitePeer::UPDATED_BY;
        }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ActivitePeer::UPDATED_BY)) {
                ...
                // blamable behavior
                if ($this->isModified() && !$this->isColumnModified(ActivitePeer::UPDATED_BY)) {
                    $this->setUpdatedBy(\Happster\Helper\Auth::getUser()->getId());
                    }
                // timestampable behavior
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActivitePeer::TIME)) {
            $modifiedColumns[':p' . $index++]  = '`time`';
        }
        if ($this->isColumnModified(ActivitePeer::PRODUCTION)) {
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addActiviteRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addActivitesRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addActiviteRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addActivitesRelatedByUpdatedBy($this);
             */
        }
