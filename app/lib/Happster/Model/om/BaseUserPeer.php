...
use Happster\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Happster\\Model\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Happster\\Model\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Happster\Model\map\UserTableMap());
      }
    }
