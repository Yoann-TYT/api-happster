...
use Happster\Model\map\HistoriqueTableMap;

/**
 * Base static class for performing query and update operations on the 'historique' table.
 *
 *
 *
 * @package propel.generator..om
 */
abstract class BaseHistoriquePeer
{
    ...
    const OM_CLASS = 'Happster\\Model\\Historique';
    ...
    const TIME = 'historique.time';

    /** the column name for the budget_souhaite field */
    const BUDGET_SOUHAITE = 'historique.budget_souhaite';

    /** the column name for the consommation field */
    const CONSOMMATION = 'historique.consommation';
    ...
    const UPDATED_BY = 'historique.updated_by';

    /** the column name for the created_at field */
    const CREATED_AT = 'historique.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'historique.updated_at';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Historique objects.
    ...
    {
        $toNames = HistoriquePeer::getFieldNames($toType);
        $key = isset(HistoriquePeer::$fieldKeys[$fromType][$name]) ? HistoriquePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(HistoriquePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, HistoriquePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return HistoriquePeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. HistoriquePeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(HistoriquePeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(HistoriquePeer::ID);
            $criteria->addSelectColumn(HistoriquePeer::TIME);
            ...
            $criteria->addSelectColumn(HistoriquePeer::UPDATED_AT);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(HistoriquePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = HistoriquePeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return HistoriquePeer::populateObjects(HistoriquePeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param Historique $obj A Historique object.
     ...
     *
     * @param      mixed $value A Historique object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(HistoriquePeer::$instances[$key]);
        }
     ...
     * @return Historique Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(HistoriquePeer::$instances[$key])) {
                return HistoriquePeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (HistoriquePeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        HistoriquePeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to historique
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = HistoriquePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = HistoriquePeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                HistoriquePeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
    ...
    {
        $key = HistoriquePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = HistoriquePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + HistoriquePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = HistoriquePeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of Historique objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Historique objects.
    ...
    public static function doSelectJoinUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Historique) to $obj2 (User)
    ...
    public static function doSelectJoinUserRelatedByUpdatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Historique) to $obj2 (User)
                $obj2->addHistoriqueRelatedByUpdatedBy($obj1);
    ...
    /**
     * Selects a collection of Historique objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Historique objects pre-filled with all related objects except UserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Historique objects pre-filled with all related objects except UserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(HistoriquePeer::DATABASE_NAME)->getTable(HistoriquePeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseHistoriquePeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseHistoriquePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Happster\Model\map\HistoriqueTableMap());
      }
    }
    ...
    {
        return HistoriquePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Historique or Criteria object.
     *
     * @param      mixed $values Criteria or Historique object containing data that is used to create the INSERT statement.
    ...
    {
        if ($con === null) {
            $con = Propel::getConnection(HistoriquePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity
        } else {
            $criteria = $values->buildCriteria(); // build Criteria from Historique object
        }

        if ($criteria->containsKey(HistoriquePeer::ID) && $criteria->keyContainsValue(HistoriquePeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.HistoriquePeer::ID.')');
        }
    ...
    /**
     * Performs an UPDATE on the database, given a Historique or Criteria object.
     *
     * @param      mixed $values Criteria or Historique object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(HistoriquePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(HistoriquePeer::ID);
            $value = $criteria->remove(HistoriquePeer::ID);
            if ($value) {
                $selectCriteria->add(HistoriquePeer::ID, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(HistoriquePeer::TABLE_NAME, $con, HistoriquePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            HistoriquePeer::clearInstancePool();
            HistoriquePeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            HistoriquePeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given Historique object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param Historique $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(HistoriquePeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(HistoriquePeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(HistoriquePeer::DATABASE_NAME, HistoriquePeer::TABLE_NAME, $columns);
    }
...
//
BaseHistoriquePeer::buildTableMap();
