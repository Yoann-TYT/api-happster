 ...
 */
abstract class BaseHistorique extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Happster\\Model\\HistoriquePeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = HistoriquePeer::ID;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HistoriquePeer::TIME;
            }
    ...
    public function setBudgetSouhaite($v)
    {
        ...
        if ($this->budget_souhaite !== $v) {
            ...
            $this->modifiedColumns[] = HistoriquePeer::BUDGET_SOUHAITE;
        }
    ...
    public function setConsommation($v)
    {
        ...
        if ($this->consommation !== $v) {
            $this->consommation = $v;
            $this->modifiedColumns[] = HistoriquePeer::CONSOMMATION;
        }
    ...
    public function setProduction($v)
    {
        ...
        if ($this->production !== $v) {
            $this->production = $v;
            $this->modifiedColumns[] = HistoriquePeer::PRODUCTION;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = HistoriquePeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = HistoriquePeer::UPDATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HistoriquePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HistoriquePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = HistoriquePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = HistoriqueQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(HistoriquePeer::UPDATED_BY)) {
                    $this->setUpdatedBy(\Happster\Helper\Auth::getUser()->getId());
                    }
                // timestampable behavior
                if (!$this->isColumnModified(HistoriquePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(HistoriquePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // blamable behavior
                if ($this->isModified() && !$this->isColumnModified(HistoriquePeer::UPDATED_BY)) {
                    $this->setUpdatedBy(\Happster\Helper\Auth::getUser()->getId());
                    }
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(HistoriquePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                HistoriquePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HistoriquePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(HistoriquePeer::TIME)) {
            $modifiedColumns[':p' . $index++]  = '`time`';
        }
        if ($this->isColumnModified(HistoriquePeer::BUDGET_SOUHAITE)) {
            $modifiedColumns[':p' . $index++]  = '`budget_souhaite`';
        }
        if ($this->isColumnModified(HistoriquePeer::CONSOMMATION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`budget_souhaite`':
                        $stmt->bindValue($identifier, $this->budget_souhaite, PDO::PARAM_STR);
                        break;
                    case '`consommation`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = HistoriquePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = HistoriquePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HistoriquePeer::ID)) $criteria->add(HistoriquePeer::ID, $this->id);
        if ($this->isColumnModified(HistoriquePeer::TIME)) $criteria->add(HistoriquePeer::TIME, $this->time);
        ...
        if ($this->isColumnModified(HistoriquePeer::UPDATED_AT)) $criteria->add(HistoriquePeer::UPDATED_AT, $this->updated_at);
     ...
     *
     * @return HistoriquePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new HistoriquePeer();
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addHistoriqueRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addHistoriquesRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addHistoriqueRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addHistoriquesRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(HistoriquePeer::DEFAULT_STRING_FORMAT);
    }
